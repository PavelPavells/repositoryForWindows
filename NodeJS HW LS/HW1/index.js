...
const saveFileToOutput = (function() {
    return(fullFilePath, filename) => {
        ...
        const classDirPathpath = path.join(resDir, fileExt, classDir);
        const newFilePath = path.join(classDirPathpath, filename);
