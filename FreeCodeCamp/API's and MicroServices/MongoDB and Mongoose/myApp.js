...
* ==================================
***********************************************/
//mongodb://<Pavel_Smirnov_>:<crysis123456789>@ds257851.mlab.com:57851/freecodecamp_tasks_db
/** # MONGOOSE SETUP #
/*  ================== */
...
//var Person = new mongoose.Schema({ name: 'string', age: 23, favoriteFoods: ['banana', 'orange']});
...
var createAndSavePerson = function(done) {
  ...
  const person = new Person({name: 'Joe', age: 21, favoriteFoods: ['burger', 'pizza']});
